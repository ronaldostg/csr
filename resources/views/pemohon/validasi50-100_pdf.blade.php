...
<p class="text-center">Center aligned text on all viewport sizes.</p> -->
                ...
                <tr>
                    <td>
                        ...
                        <div style="margin-left: 10%">
                            ...
                            @endif
                            Nama / Judul Program Kemitraan<br />
                        </div>
                ...
                <tr>
                    <td>
                        <div style="margin-left: 10%">
                            ...
                            Surat Pernyataan Asli Bahwa
                            Program Kemitraan tidak <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ditampung dalam APBD /APBN
    ...
    <p style="font-weight: bold;margin-top: 20px"><strong><u>II. KESIMPULAN DAN USUL</u></strong></p>
    <h4> Kesimpulan </h4>
    ...
    <table class="table">
        <tr>
            <td>
                <p style="text-align: left; margin-left: 300px;">Mengetahui&nbsp;<br />{{ explode(',', $nama_surat[2]['value_setting'])[1] }}</p>
            </td>
            <td>
                {{-- <p style="text-align: left; margin-left: 360px;">Sekretaris P</p><br><br><br> --}}
            </td>
        </tr>
    ...
    <table class="table">
        <tr>
            <td>
                <p style="text-align: left; margin-left: 300px; margin-top:80px">{{ explode(',', $nama_surat[2]['value_setting'])[0] }}&nbsp;<br />Pemimpin</p>
            </td>
            <td>
                {{-- <p style="text-align: left; margin-left: 360px;">Sekretaris P</p><br><br><br> --}}
            </td>
...
<p style="margin-bottom: 60px; margin-top: 100px">&nbsp;</p>
...
<table class="table" style="color: #232323;
    ...
    padding: 8px 20px;" class="text-center">
        ...
        <th style="width: 20% ;border: 1px solid;"> Keputusan/Catatan<br /> Direktur Utama</th>
        <th style="width: 5% ;border: 1px solid;"> Tanggal</th>
        <th style="width: 20% ;border: 1px solid;"> Tanda Tangan</th>
    </tr>

    <tr style="border: 2px solid #999;">
        <td style="border: 1px solid;"> &nbsp;</br>&nbsp;</br>&nbsp;</br>&nbsp;</br>&nbsp;</br>&nbsp;</br></td>
